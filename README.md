...
Все продукты наследуются от единого абстрактного базового класса

### Миксин ReprMixin для логирования
Автоматическое логирование создания объектов и техническое представление
from src.product import Product

При создании объекта выводится в консоль:
product = Product("Ноутбук", "Игровой", 75000.0, 5)
В консоли: Создан объект Product('Ноутбук', 'Игровой', 75000.0, 5)

__repr__ для разработчиков:
print(repr(product))
Product(name='Ноутбук', description='Игровой', _price=75000.0, quantity=5)

__str__ для пользователей:
print(product)
Ноутбук, 75000.0 руб. Остаток: 5 шт.
